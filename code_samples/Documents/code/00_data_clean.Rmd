...
df <- read.csv("cces2016_common_first.csv", header = T, 
...
``` {r export}
# Remove Those w/o stated Clinton Trump vote
df <- df[!is.na(df$clinton), ]
# Export Cleaned Data
write.csv(df, "cces2016_cleaned.csv", row.names = F)
```